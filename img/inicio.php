...
/*]]>*/
			...
			</script>			<script type='text/javascript' src='js/ajax.js'>			</script> 
				<script language='javascript' type='text/javascript'> 
 
 
 
// Modifications by  - Autohide, Frequency re-configuration
      ...
      <tr>
        ...
        <input name="tipo" type="hidden" id="tipo" value="Orçamento" />
          <table border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
              <td colspan="2" align="center" valign="middle" ><img src="img/orcamento.jpg" width="50%" height="37%" /></td>
              </tr>
            <tr>
...
<option value="Locacao">Locação</option>
                ...
                <option value="Pacotes Turistiscos">Pacotes Turistiscos</option>
            ...
            <tr>
              ...
              <td align="left" valign="middle"><input name="nome" type="text" class="idleField" id="#name" onfocus="cleanit(this);refresh_nu()" width="100%" style=" width:200px;" /></td>
            </tr>
            <tr>
              <td align="right" valign="middle"><strong>R.G.: &nbsp;</strong></td>
              <td align="left" valign="middle"><input name="RG" type="text" class="idleField"  id="#status" onfocus="cleanit(this);refresh_nu()" width="100%" style=" width:200px;" /></td>
            </tr>
            <tr>
              <td align="right" valign="middle"><strong>Fone: &nbsp;</strong></td>
              <td align="left" valign="middle"><input name="fone" type="text" class="idleField"  id="fone" width="100%" onfocus="cleanit(this);refresh_nu()" style=" width:200px;" /></td>
            </tr>
            <tr>
              <td align="right" valign="middle"><strong>E-mail: &nbsp;</strong></td>
              <td align="left" valign="middle"><input name="email" type="text" class="idleField"  id="#email" width="100%"onfocus="cleanit(this);refresh_nu()" style=" width:200px;" /></td>
            </tr>
            <tr>
              <td align="right" valign="middle"><strong>Comentário:</strong> &nbsp;</td>
              <td align="left" valign="middle"><textarea name="obs" rows="4" class="idleField" id="#message" width="100%" style=" width:200px;" onfocus="cleanit(this);refresh_nu()"></textarea></td>
            </tr>
            <tr>
        ...
        <td width="2%">&nbsp;</td>
        <td width="30%"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
          ...
          <tr>
            <td align="center" valign="middle"><a href="feiras.php"><img src="img/feiras.png" width="220" height="88" /></a></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
