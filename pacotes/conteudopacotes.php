...
<?php
	...
	include_once("conectar.php");
		...
		$y=1;
		$cp=$campo[0];
		$conteudo="select * from fotos where cat='pacotes' and id='".$cd."'";
...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
    ...
    <td width='49%' align='center' valign='middle'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
      ...
      <tr>
        <td width='50%' align='center' valign='middle'><p><strong><a href='../fotos/adicionar.php?cd=".$cd."&categoria=pacotes'>Adicionar imagem </a></strong></p><p><a href=../fotos/adicionar.php?cd=".$cd."&categoria=pacotes><img src='criar.png' width='32' height='32' /></a></p></td>
        <td width='50%' align='center' valign='middle'><p><strong><a href='../fotos/deletar.php?cd=".$cd."&categoria=pacotes'>Apagar imagem</a></strong></p><p><a href='../fotos/deletar.php?cd=".$cd."&categoria=pacotes'><img src='delete.png' width='32' height='32' /></a></p></td>
      </tr>
      <tr>
