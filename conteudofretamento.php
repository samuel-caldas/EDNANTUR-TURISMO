...
$sql = MYSQL_QUERY("select * from frete") or die(myErro("<h1><strong>Falha na Conexão com o Banco de Dados</strong></h1>"));
...
<a href='lero.php?cd=".$campo[0]."'>
  <tr>
  	<td bgcolor='#FFCC00'>	<a href='lerfrete.php?cd=".$campo[0]."'>".$campo[0]."</td>
  	<td ".$color.">			<a href='lerfrete.php?cd=".$campo[0]."'>".$campo[1]."</td>
  	<td ".$color.">			<a href='lerfrete.php?cd=".$campo[0]."'>".$campo[3]."</td>
  	<td ".$color.">			<a href='lerfrete.php?cd=".$campo[0]."'>".$campo[10]."</td>
    <td bgcolor='#FF0000' align='center' valign='middle'><a href='deletefrete.php?cd=".$campo[0]."'><img src='img/delete.png' height='25' /></a></td>
  </tr>
  </a>
";
}
